...
SerialPort.prototype.open = function(callback) {
  ...
  this.opening = true;
  this.binding.open(this.path, this.settings, function(err) {
    this.opening = false;
    if (err) {
...
SerialPort.prototype.update = function(options, callback) {
  ...
  this.binding.update(this.settings, function(err) {
    if (err) {
      return this._error(err, callback);
    }
    if (callback) { callback.call(this, null) }
...
SerialPort.prototype.close = function(callback) {
  ...
  this.closing = true;
  this.binding.close(function(err) {
    this.closing = false;
    if (err) {
...
SerialPort.prototype.set = function(options, callback) {
  ...
  this.binding.set(settings, function(err) {
    if (err) {
...
SerialPort.prototype.get = function(callback) {
  ...
  this.binding.get(function(err, status) {
    if (err) {
...
SerialPort.prototype.flush = function(callback) {
  ...
  this.binding.flush(function(err) {
    if (err) {
...
SerialPort.prototype.drain = function(callback) {
  ...
  this.binding.drain(function(err) {
    if (err) {
