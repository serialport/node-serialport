...
const debug = require('debug')('serialport:binding');
...
switch (process.platform) {
  case 'win32':
    ...
    // TODO process.platform should perhaps be 'uwp' when the platform is UWP instead of using process.uwpDLL.
    // Currently in https://github.com/ms-iot/node, UWP is treated as a 'sub-platform' of win32.
    if (!process.uwpDLL) {
      module.exports = require('./bindings-win32');
    } else {
      module.exports = require('./bindings-uwp');
    }
    break;
  case 'darwin':
