...
import { PortInfo } from '@serialport/bindings-abstract'
 ...
 */
export function SerialPort(path: string, options: any, openCallback?: any) {
...
```
 */
SerialPort.list = (): Promise<ReadonlyArray<PortInfo>> => {
