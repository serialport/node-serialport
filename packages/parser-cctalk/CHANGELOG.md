...
# [3.1.0](https://github.com/serialport/node-serialport/compare/@serialport/parser-cctalk@2.0.2...@serialport/parser-cctalk@3.0.1) (2019-06-05)


### implementing packet byte timeouts due to cctalk documentation

* remove node6 support and upgrade codebase ([#1886])
