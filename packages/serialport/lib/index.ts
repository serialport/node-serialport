...
import { autoDetect, AutoDetectTypes, PortInfo } from '@serialport/bindings-cpp'

const debug = debugFactory('serialport')
...
export const DetectedBinding = autoDetect()
