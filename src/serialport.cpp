...
NAN_METHOD(Open) {
  ...
  baton->baudRate = options->Get(Nan::New<v8::String>("baudRate").ToLocalChecked())->ToInt32()->Int32Value();
  baton->dataBits = options->Get(Nan::New<v8::String>("dataBits").ToLocalChecked())->ToInt32()->Int32Value();
  baton->bufferSize = options->Get(Nan::New<v8::String>("bufferSize").ToLocalChecked())->ToInt32()->Int32Value();
  baton->parity = ToParityEnum(options->Get(Nan::New<v8::String>("parity").ToLocalChecked())->ToString());
  baton->stopBits = ToStopBitEnum(options->Get(Nan::New<v8::String>("stopBits").ToLocalChecked())->ToNumber()->NumberValue());
  baton->rtscts = options->Get(Nan::New<v8::String>("rtscts").ToLocalChecked())->ToBoolean()->BooleanValue();
  baton->xon = options->Get(Nan::New<v8::String>("xon").ToLocalChecked())->ToBoolean()->BooleanValue();
  baton->xoff = options->Get(Nan::New<v8::String>("xoff").ToLocalChecked())->ToBoolean()->BooleanValue();
  baton->xany = options->Get(Nan::New<v8::String>("xany").ToLocalChecked())->ToBoolean()->BooleanValue();
  baton->hupcl = options->Get(Nan::New<v8::String>("hupcl").ToLocalChecked())->ToBoolean()->BooleanValue();

  v8::Local<v8::Object> platformOptions = options->Get(Nan::New<v8::String>("platformOptions").ToLocalChecked())->ToObject();
  baton->platformOptions = ParsePlatformOptions(platformOptions);

  baton->callback = new Nan::Callback(callback);
  baton->dataCallback = new Nan::Callback(options->Get(Nan::New<v8::String>("dataCallback").ToLocalChecked()).As<v8::Function>());
  baton->disconnectedCallback = new Nan::Callback(options->Get(Nan::New<v8::String>("disconnectedCallback").ToLocalChecked()).As<v8::Function>());
  baton->errorCallback = new Nan::Callback(options->Get(Nan::New<v8::String>("errorCallback").ToLocalChecked()).As<v8::Function>());
...
void EIO_AfterList(uv_work_t* req) {
  ...
  if(data->errorString[0]) {
    ...
    for(std::list<ListResultItem*>::iterator it = data->results.begin(); it != data->results.end(); ++it, i++) {
      ...
      item->Set(Nan::New<v8::String>("comName").ToLocalChecked(), Nan::New<v8::String>((*it)->comName.c_str()).ToLocalChecked());
      item->Set(Nan::New<v8::String>("manufacturer").ToLocalChecked(), Nan::New<v8::String>((*it)->manufacturer.c_str()).ToLocalChecked());
      item->Set(Nan::New<v8::String>("serialNumber").ToLocalChecked(), Nan::New<v8::String>((*it)->serialNumber.c_str()).ToLocalChecked());
      item->Set(Nan::New<v8::String>("pnpId").ToLocalChecked(), Nan::New<v8::String>((*it)->pnpId.c_str()).ToLocalChecked());
      item->Set(Nan::New<v8::String>("locationId").ToLocalChecked(), Nan::New<v8::String>((*it)->locationId.c_str()).ToLocalChecked());
      item->Set(Nan::New<v8::String>("vendorId").ToLocalChecked(), Nan::New<v8::String>((*it)->vendorId.c_str()).ToLocalChecked());
      item->Set(Nan::New<v8::String>("productId").ToLocalChecked(), Nan::New<v8::String>((*it)->productId.c_str()).ToLocalChecked());
      results->Set(i, item);
    }
    argv[0] = Nan::Undefined();
    argv[1] = results;
...
NAN_METHOD(Set) {
  ...
  baton->fd = fd;
  baton->callback = new Nan::Callback(callback);
  baton->brk = options->Get(Nan::New<v8::String>("brk").ToLocalChecked())->ToBoolean()->BooleanValue();
  baton->rts = options->Get(Nan::New<v8::String>("rts").ToLocalChecked())->ToBoolean()->BooleanValue();
  baton->cts = options->Get(Nan::New<v8::String>("cts").ToLocalChecked())->ToBoolean()->BooleanValue();
  baton->dtr = options->Get(Nan::New<v8::String>("dtr").ToLocalChecked())->ToBoolean()->BooleanValue();
  baton->dsr = options->Get(Nan::New<v8::String>("dsr").ToLocalChecked())->ToBoolean()->BooleanValue();
